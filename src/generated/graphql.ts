...
export type CreateProductInput = {
  compoundNutritionFacts?: InputMaybe<
    Array<InputMaybe<CompoundNutritionFactInput>>
  >
...
export type DeleteFaqMutation = {
  __typename?: 'Mutation'
  deleteFaq?:
    | {__typename?: 'Faq'; id: number; question: string; answer: string}
    | null
    | undefined
}
...
export type ProductsQuery = {
  __typename?: 'Query'
  products?:
    | Array<{__typename?: 'Product'; shopifyId: number} | null | undefined>
    | null
    | undefined
}
