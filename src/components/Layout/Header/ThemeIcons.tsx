...
export const SunIcon: FC<ThemeIconProps> = ({selected, ...props}) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    strokeWidth="2"
...
export const MoonIcon: FC<ThemeIconProps> = ({selected, ...props}) => (
...
export const PcIcon: FC<ThemeIconProps> = ({selected, ...props}) => {
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path
